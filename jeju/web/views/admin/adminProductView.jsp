...
<h1>상품 상세<br>정보보기</h1>
<br>
<h5><a href="<%=request.getContextPath()%>/admin/productList">&nbsp;상품 관리페이지</a></h5>
		...
		<table>
			<tr>
				...
				<td class="int-area">
					...
					<img id="Loading" src="<%=request.getContextPath() %>/upload/partner/<%=partner.getPartnerImgRename() %>" >
				</td>
			</tr>
			<tr>
				<th>상품번호</th>
			...
			<tr>
				<th>상품이름</th>
				<td class="int-area">
					<%=product.getpBigNameKor() %>
				</td>
			</tr>
			<tr>
				<th>등록일</th>
				<td class="int-area">
					<%=product.getpDateStart()%>
				</td>
			</tr>
			<tr>
				<th>등록종료일</th>
				<td class="int-area">
					<%=product.getpDateFinish()%>
				</td>
			</tr>
			<tr>
				<th>상품가격(어른)</th>
